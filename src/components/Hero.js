        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <div className="relative">
              ...
              {/* Main Image Container (Explicitly a square with sharp corners) */}
              <motion.div
                className="relative w-80 md:w-96 aspect-square border-4 border-white/20 backdrop-blur-sm bg-gradient-to-br from-white/10 to-white/5 p-1"
              ...
              >
                ...
                {/* Floating Badges (still rounded-full for style) */}
                <motion.div
              ...
              {/* Animated Orbit (Now sharp squares) */}
              <motion.div
                className="absolute inset-0 border-2 border-blue-400/30"
                animate={{ rotate: 360 }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
              />

              <motion.div
                className="absolute inset-4 border-2 border-purple-400/30"
                animate={{ rotate: -360 }}
