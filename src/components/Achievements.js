...
const Achievements = () => {
  const achievements = [
    {
      title: 'Qualified JEE Mains & Advanced',
      description: 'Secured AIR 19317 in JEE Advanced and AIR 16913 in JEE Mains',
      icon: <FiAward className="text-2xl" />,
      gradient: 'from-yellow-500 to-orange-500'
    },
    {
      title: '500+ Problems Solved',
      description: 'Solved 500+ questions across all coding platforms including LeetCode, GeeksforGeeks, and CodeChef, demonstrating strong problem-solving skills and algorithmic thinking.',
