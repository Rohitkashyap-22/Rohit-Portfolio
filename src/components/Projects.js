  ...
  const projects = [
    {
      ...
      github: "https://github.com/Rohitkashyap-22/Chat-App.git", // Use the provided text link or replace with actual URL
      live: "https://chat-app-derl.onrender.com", // Use the provided text link or replace with actual URL
      image: "/unnamed.jpg", // Placeholder
      period: "Nov 2024 - Dec 2024",
      gradient: "from-pink-500 to-fuchsia-600", // New gradient
    },
    {
      ...
      description: [
        ...
        "Implemented secure authentication and authorization with Clerk (multi-session support + protected API routes).",
        ...
        "Built core features: dynamic search/filters, CRUD operations, and a saved jobs system, ensuring a responsive and engaging user experience.",
      ...
      github: "https://github.com/Rohitkashyap-22/Job-Portal.git", // Use the provided text link or replace with actual URL
      live: "https://job-portal-seven-mocha.vercel.app/", // Use the provided text link or replace with actual URL
      image: "/job.png", // Placeholder
      period: "July 2025 - Aug 2025",
      gradient: "from-lime-500 to-green-500", // New gradient
    },
  ];
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 transition-all duration-300">
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <img
                    ...
                    // Fallback Logic: Hide image on error and show the next element (Text Fallback Div)
                    onError={(e) => {
