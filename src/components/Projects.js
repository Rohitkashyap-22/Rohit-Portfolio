  ...
  const projects = [
    {
      ...
      description: [
        ...
        "Developed RESTful APIs for user, chat, and message operations, ensuring a modular and scalable backend architecture.",
        "Delivered an intuitive, mobile-friendly interface with React and **MUI** for a seamless cross-device user experience.",
      ],
      tech: [
        "ReactJS",
        "NodeJS",
    ...
    },
    {
      ...
      description: [
        ...
        "Implemented secure authentication and authorization using Clerk (with multi-session support and protected API routes).",
        ...
        "Built core features including dynamic search/filters, CRUD operations, and a saved jobs system, ensuring a responsive and engaging user experience.",
